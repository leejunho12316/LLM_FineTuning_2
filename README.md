...
이는 Fine-Tuning 전 기본 모델의 성능인 73.3%, 87.1%, 91.1%, 81.6%보다 18.6%, 6.5%, 4.4%, 15.1%, **평균 11.15%p 증가된 성능**이었습니다.
...
이는 FineTuning 전 기본 모델의 table 정확도인 66.4%, 76.9%, 86.0%, 76.3%보다 30.4%, 22.9%, 13.6%, 23.3%, **평균 22.55%p 증가된 성능**이었습니다.
